...
function parseTengwarWord(callback, options, columns) {
    columns = columns || [];
    return parseTengwarColumn(function (column) {
        if (column) {
            ...
            return function (character) {
                if (/\d/.test(character)) {
                    return parseNumber(function (number) {
                        return parseTengwarWord(callback, options, columns.concat(number));
                    }, options)(character);
                } else {
...
function parseTengwarColumn(callback, options) {
    return matchConsonant(function (column) {
        if (column) {
            return parseFollowingSilme(callback, column);
        } else {
            return callback();
        }
    }, options);
...
function matchConsonant(callback, options) {
        ...
        if (character === "n") { // n
            return function (character) {
                if (character === "t" || character === "d") { // n{t,d}
                    ...
                    return matchConsonant(callback, options)("ñ")(character);
            ...
            return function (character) {
                if (character === "i") { // ii -> í
                    return parseTengwarColumn(callback, options)("í");
                } else {
...
// --- Following Silme (S) parsing ---

function parseFollowingSilme(callback, column) {
    return function (character) {
        if (character === "s") {
