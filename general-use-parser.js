...
// --- Book of special word encodings ---
...
function parseTengwarWord(callback, options) {
...
function parseTengwarColumn(callback, length, options, previous) {
    var font = options.font;
    var makeColumn = font.makeColumn;
    ...
    return parseTehta(function (tehta, tehtaFrom) {
        ...
        return matchConsonant(function (column, tehta, tehtaFrom) {
            if (tehta) {
...
function matchConsonant(callback, options, tehta, tehtaFrom) {
    var font = options.font;
    var makeColumn = font.makeColumn;
    return function (character) {
        if (character === "n") {
...
// --- Tengwa annotation parsing (following W, E, S) ---
