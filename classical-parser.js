...
exports.parseTengwarWord = parseTengwarWord;
function parseTengwarWord(callback, options, columns, previous) {
    columns = columns || [];
    return parseTengwarColumn(function (moreColumns) {
        if (!moreColumns.length) {
            return callback(columns);
        } else {
            return parseTengwarWord(
                callback,
                options,
...
function parseTengwarColumn(callback, options, previous) {
    var font = options.font;
    var makeColumn = font.makeColumn;
    return matchConsonant(function (columns) {
        var previous = columns.pop();
        return parseVowel(function (next) {
...
function matchConsonant(callback, options, previous) {
    var font = options.font;
    var makeColumn = font.makeColumn;
    return function (character) {
        if (character === "n") { // n
...
function parseVowel(callback, options, previous) {
    var font = options.font;
    var makeColumn = font.makeColumn;
    return function (character) {
        if (character === "a") {
            return function (character) {
                if (character === "a") {
                    return parseVowel(callback, options, previous)("á");
                } else if (character === "i") {
            ...
            return function (character) {
                if (character === "e") {
                    return parseVowel(callback, options, previous)("é");
                } else if (character === "u") {
            ...
            return function (character) {
                if (character === "i") {
                    return parseVowel(callback, options, previous)("í");
                } else if (character === "u") {
                    if (options.iuRising) {
            ...
            return function (character) {
                if (character === "o") {
                    return parseVowel(callback, options, previous)("ó");
                } else if (character === "i") {
            ...
            return function (character) {
                if (character === "u") {
                    return parseVowel(callback, options, previous)("ú");
                } else if (character === "i") {
            ...
            if (previous && previous.canAddBelow("y-quenya")) {
                return parseVowel(callback, options, previous.addBelow("y-quenya", {from: "y"}));
            } else {
                var next = makeColumn("anna", {}).addBelow("y-quenya", {from: "y"});
                return parseVowel(function (moreColumns) {
